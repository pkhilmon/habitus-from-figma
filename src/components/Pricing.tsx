  ...
  return (
    <section className="w-[1440px] mx-auto px-25 pt-29.25">
      <div className="">
        ...
        <p className="text-dark text-[20px] mb-17 px-2.5 tracking-[-0.005em]">
          Start free. Upgrade when you&apos;re ready.
        </p>

        <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
          {/* Free card */}
          <div className="bg-light-grey rounded-[40px] px-17.5 py-16.75">
            <p className="font-semibold text-dark text-2xl mb-2.25">Free</p>
            <p className="text-grey text-[16px] mb-13">Perfect to get started</p>
            <div className="flex items-end gap-1 mb-5.5">
              <span className="text-4xl font-bold text-dark">$0</span>
            </div>
            <ul className="space-y-4 mb-21.75">
              {freeFeatures.map((f) => (
          ...
          {/* Premium card */}
          <div className="bg-dark rounded-[40px] px-17.5 py-16.75 relative">
            <div className="flex items-start justify-between mb-2">
              <p className="font-semibold text-white text-2xl">Premium</p>
              <span
                className="bg-orange text-white text-sm px-3.25 py-1 mt-1.25 rounded-full"
              >
                Popular
              </span>
            </div>
            <p className="text-gray-subline text-[16px] mb-12.75">All features you need</p>
            <div className="flex items-end gap-1 mb-5.75">
              <span className="text-4xl font-bold text-white">$4.99</span>
              <span className="text-gray-subline text-[16px] mx-1">/month</span>
            </div>
            <ul className="space-y-4 mb-12.75">
